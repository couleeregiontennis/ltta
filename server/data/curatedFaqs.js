...
export const curatedFaqs = [
  ...
  {
    topic: 'playing_down',
    keywords: 'playing down level lower play down sub',
  ...
  {
    topic: 'playing_up',
    keywords: 'playing up higher level sub play up',
  ...
  {
    topic: 'extreme_heat',
    keywords: 'heat extreme temperature hot 95 104 weather cancel feels like',
    question: 'What is the extreme heat rule?',
    answer: 'If the "Feels Like" temperature exceeds 95°F, any player may request to begin sets at 2-2 (still playing best 2 of 3). If the "Feels Like" temperature exceeds 104°F, league play is canceled by 4:30 PM.'
  },
  {
    topic: 'rain_weather',
    keywords: 'rain raining rainout weather cancel 5:30 7:00 independent',
  ...
  },
  {
    ...
    keywords: 'forfeit late time start 5:45 7:15 15 minutes',
    question: 'When do match forfeits take effect?',
    answer: 'Matches begin promptly at 5:30 PM and 7:00 PM. Warm-ups are limited to 10 minutes. Forfeits take effect at 5:45 PM and 7:15 PM if players are not on their assigned court (aside from weather delays).'
  },
  {
    topic: 'scoring_format',
    keywords: 'scoring format no ad sets deuce deciding point',
  ...
  {
    topic: 'court_vacate',
    keywords: '7:00 vacate unfinished stoppage 5:30 time limit',
  ...
  {
    topic: 'substitutes',
    keywords: 'sub substitute sub list non sanctioned rating fee',
  ...
  },
  {
    ...
    keywords: 'standings tie tiebreaker championship head to head winning percentage',
  ...
  // Official Tennis / USTA Friend at Court Rules
  {
    ...
    keywords: 'net cord serve let service box lands in hit net',
  ...
  {
    topic: 'ball_on_line',
    keywords: 'ball line in out line good touches line',
  ...
  {
    topic: 'doubtful_call',
    keywords: 'benefit doubt unsure call see close line call',
  ...
  },
  {
    ...
    keywords: 'ball roll rolling court let stray interference distraction',
  ...
  {
    topic: 'touching_net',
    keywords: 'touch net racket body clothes during point',
  ...
  },
  {
    ...
    keywords: 'reach over net hit ball before crosses plane',
  ...
  },
  {
    ...
    keywords: 'catch caught ball air out fly baseline before bounce',
  ...
  },
  {
    ...
    keywords: 'talking hindrance partner yell scream distract noise',
  ...
  {
    topic: 'foot_fault',
    keywords: 'foot fault baseline serve line step',
  ...
  {
    topic: 'score_dispute',
    keywords: 'score dispute disagree points games resolution count',
  ...
  },
  {
    ...
    keywords: 'two bounces double bounce carry double hit',
  ...
  {
    topic: 'warmup_serves',
    keywords: 'warm up serves practice first ball in',
